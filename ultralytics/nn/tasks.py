...
from ultralytics.nn.modules import (
    ...
    C3k2_Dental,
    # Small object detection modules
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            SCDown,
            C2fCIB,
            C3k2_Dental,  # Dental-specific module
            DentalChannelAttention,
            DentalCBAM,
            EfficientChannelAttention,
            SmallObjectAttention,
            ...
            c2 = ch[f[-1]]
        elif m.__name__ == "PriorAsAttentionInput":
            c2 = 3  # 4ch input → 3ch output (prior converted to attention on RGB)
        else:
            c2 = ch[f]
